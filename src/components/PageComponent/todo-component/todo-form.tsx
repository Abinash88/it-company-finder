...
const TodoForm = ({ setIsOpenPopup }: popupPassword) => {
  ...
  return (
    ...
    >
      ...
      >
        <Form {...form}>
          <form className="flex flex-col gap-2" action="" onSubmit={handleSubmit(onSubmitForm)}>
            ...
            <Div className=" flex-1 flex flex-col relative gap-[4px] md:gap-1">
              <Controller
                ...
                control={form.control}
                render={({ field }) => (
                  <ComboboxDemo label="Priority" className="" onChange={field.onChange} listData={selectNotePriority} />
                )}
              />
            </Div>
            ...
            <Div className="flex w-full justify-start gap-4 items-center">
              ...
              <Button type="button" variant='outline' onClick={() => { reset() }} size='md'>
                Reset
              </Button>
            </Div>
          </form>
