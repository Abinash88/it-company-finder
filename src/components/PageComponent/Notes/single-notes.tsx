    ...
    >
      ...
      <Div className=' h-full  backdrop-blur-5   top-[-12px] rounded-md  left-0'>
        <Div
          ...
          className='h-full mt-5 flex flex-col gap-1 '
        >
          <h2 className='text-[15px] text-gray-600 font-normal'>
            {data?.title}
          </h2>
          <p className='text-[11px]   w-[80%] text-gray-600 font-normal'>
      ...
      <Div className=' flex-1 flex gap-4 px-4 items-center justify-end '>
        <FaRegCopy
          ...
          className='text-gray-600 hover:bg-gray-100 text-[22px] rounded-md p-[3px]'
        />
